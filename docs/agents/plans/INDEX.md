...
| `run00601-records-strategy-shootout` | `ready_for_execution` | `modify_plugin` | `strict` | `staged` | `—` | `docs/agents/runs/current/run00601-records-strategy-shootout/task.yaml` |
