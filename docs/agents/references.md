...
## 生命周期与协议
<!-- BEGIN GENERATED: protocol_index -->
...
## Adapters
<!-- BEGIN GENERATED: adapter_index -->
- `docs/agents/adapters/skills.md`
- `docs/agents/adapters/mcp.md`
<!-- END GENERATED: adapter_index -->
...
- Auto: `docs/plugins/reference/builtin/auto/INDEX.md`
