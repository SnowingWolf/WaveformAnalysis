...
export function parseSiteModel(value: unknown): SiteModel {
  ...
  if (!records || records.version !== "0.15.1" || records.dependsOn[0] !== "raw_files") {
    throw new SiteModelValidationError("records fixture must be v0.15.1 with raw_files as its first dependency");
  }
