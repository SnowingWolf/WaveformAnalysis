...
| `peaks` | HitFinderPlugin, ThresholdHitPlugin, HitMergeClustersPlugin, HitMergePlugin, HitMergedComponentsPlugin, HitMergedFeaturesPlugin, PeakletPlugin, PeakletComponentsPlugin, PeakletChannelsPlugin, WaveformWidthPlugin, S1S2ClassifierPlugin | 峰值检测、peaklet 构建与峰特征扩展 |
