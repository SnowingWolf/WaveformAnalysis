...
| [`peaklets`](peaklets.md) | Build cross-channel peaklets and compute pulse-level feature... | hit_merged, hit_merged_components, hit_merged_features, records, wave_pool |
