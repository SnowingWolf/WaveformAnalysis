...
| 插件 | 提供数据 | 版本 | 类别 | 依赖 |
|------|----------|------|------|------|
| [`BasicFeaturesPlugin`](basic_features.md) | `basic_features` | 3.4.0 | 特征提取 | - |
...
| [`WaveformWidthIntegralPlugin`](waveform_width_integral.md) | `waveform_width_integral` | 2.2.0 | 波形处理 | - |
