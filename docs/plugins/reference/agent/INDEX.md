...
| [`hit_merged`](hit_merged.md) | `HitMergePlugin` | `hit_threshold` | `hit_threshold` | - | `structured_array` | `static` | `published` | `2.2.0` |
...
| [`records`](records.md) | `RecordsPlugin` | - | `raw_files` | `daq_adapter`, `input_source` | `structured_array` | `static` | `source` | `0.15.0` |
...
| [`wave_pool`](wave_pool.md) | `WavePoolPlugin` | - | `raw_files` | `daq_adapter`, `input_source` | `array` | `static` | `source` | `0.15.0` |
