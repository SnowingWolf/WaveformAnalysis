...
| [`hit_merge_clusters`](hit_merge_clusters.md) | `HitMergeClustersPlugin` | `hit_merged`, `hit_threshold` | `hit_merged`, `hit_threshold` | - | `structured_array` | `static` | `source` | `1.2.0` |
| [`hit_merged`](hit_merged.md) | `HitMergePlugin` | `hit_threshold` | `hit_threshold` | - | `structured_array` | `static` | `published` | `2.2.1` |
| [`hit_merged_components`](hit_merged_components.md) | `HitMergedComponentsPlugin` | `hit_merged`, `hit_threshold` | `hit_merged`, `hit_threshold` | - | `structured_array` | `static` | `source` | `1.2.0` |
...
| [`peaklet_features`](peaklet_features.md) | `PeakletFeaturesPlugin` | `peaklet_waveforms`, `peaklet_waveform_pool`, `peaklets` | `peaklet_waveforms`, `peaklet_waveform_pool`, `peaklets` | - | `structured_array` | `static` | `source` | `5.1.0` |
...
| [`peaklet_waveforms`](peaklet_waveforms.md) | `PeakletWaveformPlugin` | - | `peaklets`, `peaklet_components`, `hit_merged`, `hit_merged_components`, `hit_threshold`, `records`, `wave_pool` | `clip_negative_signal`, `use_filtered` | `structured_array` | `static` | `source` | `2.2.1` |
...
| [`peaks`](peaks.md) | `PeaksPlugin` | `peaklets`, `peaklet_features` | `peaklets`, `peaklet_features` | - | `structured_array` | `static` | `source` | `5.1.0` |
...
| [`records`](records.md) | `RecordsPlugin` | - | `raw_files` | `daq_adapter`, `input_source` | `structured_array` | `static` | `source` | `0.15.2` |
...
| [`wave_pool`](wave_pool.md) | `WavePoolPlugin` | - | `raw_files` | `daq_adapter`, `input_source` | `array` | `static` | `source` | `0.15.2` |
