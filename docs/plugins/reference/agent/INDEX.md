...
| [`records`](records.md) | `RecordsPlugin` | - | `raw_files` | `daq_adapter`, `input_source` | `structured_array` | `static` | `source` | `0.15.1` |
...
| [`wave_pool`](wave_pool.md) | `WavePoolPlugin` | - | `raw_files` | `daq_adapter`, `input_source` | `array` | `static` | `source` | `0.15.1` |
