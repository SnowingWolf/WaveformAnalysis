...
**导航**: [文档中心](../../README.md) > [功能特性](../README.md) > core
...
#### 理解 time/timestamp 的差异
→ [TIME_FIELD_UNIFICATION.md](TIME_FIELD_UNIFICATION.md)

#### 进行绝对时间查询
→ [ABSOLUTE_TIME_GUIDE.md](ABSOLUTE_TIME_GUIDE.md)
...
**快速链接**:
[时间字段统一](TIME_FIELD_UNIFICATION.md) |
[绝对时间查询](ABSOLUTE_TIME_GUIDE.md) |
