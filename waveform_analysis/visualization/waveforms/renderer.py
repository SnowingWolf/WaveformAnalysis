...
# Preserve historical implementation metadata exposed through the compatibility facade.
for _name in (
    "plot_waveforms",
    "create_interactive_browser",
    "_plot_peak_channels_with_sum_impl",
    "create_peak_plotter",
    "plot_peak_channels_with_sum",
):
    globals()[_name].__module__ = "waveform_analysis.visualization.waveform_visualizer"
