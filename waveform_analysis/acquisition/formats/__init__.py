...
_LEGACY_CLASS_MODULES = {
    ColumnMapping: "waveform_analysis.utils.formats.base",
    FormatReader: "waveform_analysis.utils.formats.base",
    FormatSpec: "waveform_analysis.utils.formats.base",
    RawTimestampMode: "waveform_analysis.utils.formats.base",
    TimestampUnit: "waveform_analysis.utils.formats.base",
    DirectoryLayout: "waveform_analysis.utils.formats.directory",
    GenericCSVReader: "waveform_analysis.utils.formats.generic",
    DAQAdapter: "waveform_analysis.utils.formats.adapter",
    VX2730Reader: "waveform_analysis.utils.formats.vx2730",
    VX2730Spec: "waveform_analysis.utils.formats.vx2730",
    V1725Reader: "waveform_analysis.utils.formats.v1725",
    V1725Adapter: "waveform_analysis.utils.formats.v1725",
    V1725Spec: "waveform_analysis.utils.formats.v1725",
}
for _class, _legacy_module in _LEGACY_CLASS_MODULES.items():
    _class.__module__ = _legacy_module


def ensure_builtin_formats_registered() -> None:
    """Idempotently install the built-in readers and adapters in shared registries."""
...
ensure_builtin_formats_registered()
