...
.. deprecated:: 
    This plugin is deprecated. Use PeaksPlugin and ChargesPlugin instead,
    which compute features directly from st_waveforms without intermediate steps.
...
**提供数据**: `peaks`
**依赖**: st_waveforms
Plugin to compute peaks directly from st_waveforms.
...
- **类型**: `<class 'tuple'>`
- **默认值**: `(40, 90)`
- **说明**: Range for peak calculation (start, end) in samples
...
**提供数据**: `charges`
**依赖**: st_waveforms
Plugin to compute charges directly from st_waveforms.
...
- **类型**: `<class 'tuple'>`
- **默认值**: `(60, 400)`
- **说明**: Range for charge calculation (start, end) in samples
